const CONFIG = {
  ...
  PRIVACY_TEXT: 'Wir erheben unternehmensbezogene Angaben ohne Personenbezug. Einzige personenbezogene Angabe ist Ihre E-Mail-Adresse für Rückfragen und die Zusendung von Ergebnissen. Rechtsgrundlage: Einwilligung (Art. 6 Abs. 1 a DSGVO). Widerruf jederzeit mit Wirkung für die Zukunft möglich. Empfänger/Auftragsverarbeiter: n8n (self-hosted) auf Servern der Hetzner Online GmbH (Deutschland/EU) sowie Supabase, Inc. in Central EU (Frankfurt). Speicherdauer: bis Abschluss der Kommunikation/Ergebnisversand, spätestens 12 Monate oder bis Widerruf. Keine automatisierten Entscheidungen/Profiling. Rechte: Auskunft, Berichtigung, Löschung, Einschränkung, Datenübertragbarkeit, Beschwerde. Verantwortlicher: Carlo Nicolussi, Am Dahlberg 8, 46244 Bottrop, carlo@workglaze.com',
